    ...
    <DIV class="container">
        ...
        <table class="table table-bordered">
            ...
            <?php
                ...
                echo "<h1>Pesquisa de Países</h1>";

                $sql = "select * from paises where pais like '%$_POST[pais]%';";
        ...
        <a href="formulario_inserir_paises.php" class="btn btn-primary">Cadastrar novo</a>
    </DIV>
